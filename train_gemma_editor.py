...
if __name__ == "__main__":
    ...
    with open(args.data_addr, "r") as f:
        ...
        dataset = datasets.Dataset.from_list(
            [{
                ...
                "plan": data["plan"]['parsed_queries'],
                "output_neg": data["output_neg"],
    ...
    formatter = get_query_planning_local_search_formatter(True)
    collator = DataCollatorForCompletionOnlyLM(response_template="improved response:", tokenizer=tokenizer)
